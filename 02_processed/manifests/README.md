...
The master manifest CSV is intentionally initialized with only the required header. Do not place commented rows inside the CSV.

Example rows for future use:
...
Before adding real rows, confirm the source rights and compute hashes when practical:
